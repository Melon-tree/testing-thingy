...
ball = pygame.image.load('pong.png').convert_alpha()
...
paddle1 = pygame.image.load('pongpaddle.png').convert_alpha()
paddle1_rect = paddle1.get_rect(center=(555, height/2))

paddle2 = pygame.image.load('pongpaddle.png').convert_alpha()
